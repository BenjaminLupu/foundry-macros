...
(async () => {
    const forgeId = ""; // Copy your ForgeId here
    const formula = "{1d4x[basic-d4],1d6x[basic-wild-die]}kh"; // Set die used
    ...
    // Get die images
    const dieIcons = {
        "standard-die-icon": `https://assets.forge-vtt.com/${forgeId}/dice-icons/d${standardDie.faces}.webp`, // Note that die filename is d[faces].webp (eg. d4.webp)
        "wild-die-icon": `https://assets.forge-vtt.com/${forgeId}/dice-icons/wild-die.webp`
    };
        ...
        content: `
            ...
            ">
                ...
                <div style="display:flex;align-items:center;gap:12px;">
                    ...
                    <img src="${user.avatar}" style="width:64px;height:64px;border-radius:6px;border:1px solid #8b5e3c;object-fit:cover;" />
                    
                    <div style="display:flex;flex-direction:column;gap:4px;">

                        <!-- Displaying the result of the trait die roll, showing any aces -->
                        <div style="display:flex;align-items:center;gap:6px;">
                            <img src="${dieIcons['standard-die-icon']}" style="width:24px;height:24px;" />
                            <span>${formatDie(standardDie)}</span>
                        </div>

                        <!-- Displaying the result of the wild die roll, showing any aces -->
                        <div style="display:flex;align-items:center;gap:6px;">
                            <img src="${dieIcons['wild-die-icon']}" style="width:24px;height:24px;" />
